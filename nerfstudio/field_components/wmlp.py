...
class RealGaborLayer(nn.Module):
    ...
    def __init__(self, in_ft, out_ft, bias=True, is_first=False, omega0=10.0, sigma0=10.0, trainable=False) -> None:
        super().__init__()
        self.omega_0 = omega0
        self.scale_0 = sigma0
        ...
        if self.num_layers == 1:
            ...
            for i in range(self.num_layers - 1):
                if i == 0:
                    ...
                    layers.append(RealGaborLayer(self.in_dim, self.layer_width))
                elif i in self._skip_connections:
                    layers.append(RealGaborLayer(self.layer_width + self.in_dim, self.layer_width))
                else:
                    layers.append(RealGaborLayer(self.layer_width, self.layer_width))
